                ...
                <table class="table-auto w-full text-left border-collapse">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">Nama Warga</th>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">NIK</th>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">No Telepon</th>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">Password</th>
