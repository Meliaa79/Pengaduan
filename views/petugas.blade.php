    ...
    <div class="min-h-screen flex">
        ...
        <main class="flex-grow p-6">
            ...
            <header class="flex justify-between items-center mb-6">
                ...
                <a href="/tambahdatapetugas" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
                    Tambah Data
                </a>
            </header>
            ...
            <div class="overflow-x-auto bg-white shadow-md rounded-lg">
                <table class="table-auto w-full text-left border-collapse">
                    <thead class="bg-gray-200">
                        <tr>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">No</th>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">Nama Petugas</th>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">No Telepon</th>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">Alamat</th>
                            <th class="border px-4 py-2 text-sm font-medium text-gray-700">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr class="odd:bg-gray-50">
                        ...
                        <a href="{{ route('petugas.edit', $petugas->id) }}" class="text-blue-500 hover:text-blue-700">
                            <i class="fa-solid fa-pen-to-square text-lg"></i>
                        </a>


                            <!-- Form untuk menghapus data petugas -->
                            <form action="{{ route('petugas.destroy', $p->id) }}" method="POST" class="inline-block" id="delete-form-{{ $p->id }}">
                                @csrf
                                @method('DELETE')
